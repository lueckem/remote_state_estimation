...
def random_sensor_different_alpha():
    ...
    np.save("alphas0.npy", alphas)
    np.save("erru0.npy", err_u)
    np.save("erre0.npy", err_e)
...
def plot_eval():
    ...
    # filter out the noise of estimating the mean by long simulations
